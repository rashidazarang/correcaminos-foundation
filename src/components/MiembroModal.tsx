          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              {miembro.fotoPerfil ? (
                ...
                <div className="w-[200px] h-[200px] rounded-full bg-gris-calzada/20 flex items-center justify-center mx-auto mb-6 border-4 border-crema-jersey">
                  <span className="font-display text-4xl text-gris-humo">
                    {iniciales}
                  </span>
                </div>
              )}
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              {miembro.maratonesSub3 && miembro.maratonesSub3 > 0 && (
                <div className="bg-crema-jersey p-4 text-center">
                  <span className="font-mono text-2xl text-primary block">
